...
const NAV_SECTIONS: { heading: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/pharmacy-categories', label: 'Categories', icon: FolderTree, anyOf: ['categories.view'], verticals: ['pharmacy'] },
      { to: '/pharmacy-import', label: 'Import medicines', icon: FileUp, anyOf: ['products.import'], feature: 'productImport', verticals: ['pharmacy'] },
