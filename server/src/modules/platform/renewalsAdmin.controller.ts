...
import { sendRenewalReminders } from '../../services/subscription/renewalNotices.service';
...
export const runRenewals = asyncHandler(async (req: Request, res: Response) => {
  ...
  const result = { reminders, wallet, renewedByProvider, expired, invoices, receipts };
